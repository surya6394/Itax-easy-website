...
const ApplicationForm = () => {
  ...
  return (
    <>
      <div className="px-1 grid md:grid-cols-2 lg:gap-0 gap-2 md:py-5" id="careerForm">
        <form
        ...
        <div className="flex justify-center shadow-xl">
          <div className="px-12 py-10">
            ...
            <div className="text-lg flex my-4 [&>div]:flex [&>div]:items-center [&>div]:gap-5 flex-col gap-12">
              <p className="mt-8">We're open for any suggestion or any query..</p>
              <div>
                <svg
                ...
                <p>G - 41, Gandhi Nagar, Near Defence Colony,Padav Gwalior 474002 (M.P)</p>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
