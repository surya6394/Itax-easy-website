    ...
    <>
      ...
      >
        <div className="grid lg:grid-cols-4 md:grid-cols-2 justify-center">
          ...
          <p className="text-lg mt-5">Discover innovative technology solutions tailored to elevate your business to new heights.Your Vision, Our IT Expertise. Elevate Your Business with US. Innovate, Transform, Succeed</p>
        </div>
        <hr className="border-1 ml-2 mt-5" width="80%"/>
            <div className="flex gap-4">
              ...
              <div className="flex">
                ...
                <p className="ml-2 font-sans" onClick={handlePhoneNumberClick}>{phoneNumber}</p>
              </div>
            </div>
            <div>
          ...
          <h2 className="flex text-xl font-bold pt-10 pb-7 justify-center font-sans"><span className="border-b-2 -border--clr-accent-200">Off</span>ice</h2>
          <div className="pl-10">
            <h2 className="font-bold text-lg">Main Branch:-</h2>
          <address class="text-sm">
          G - 41, Gandhi Nagar, <br/>
          Near Defence Colony,Padav Gwalior<br/>
          474002 (M.P)
        </address>
          </div>
          ...
          <address class="text-sm">
          Sat 1 ,Flat - 811,<br/>
          Logix Zest Blossom, Sector 143,<br/>
          Noida 201306 ( U.P)
        </address>
          </div>
          ...
          <AiFillMail size={26} />
          <a className="pl-2" href="mailto:support@itaxeasy.com">support@itaxeasy.com</a>
          
          </div>
          </div>

          <div className="flex flex-col">
            <h2 className="flex text-xl font-bold py-10 justify-center font-sans"><span className="border-b-2 -border--clr-accent-200">Quic</span>k Access</h2>
          ...
          <h2 className="flex text-xl font-bold pt-10 pb-7 justify-center font-sans"><span className="border-b-2 -border--clr-accent-200">Get i</span>n Touch</h2>
